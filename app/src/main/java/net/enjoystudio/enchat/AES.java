...
public class AES {
    ...
    public static byte[] encrypt(byte[] in, byte[] key) {
        ...
        Nb = 4; //banyaknya blok selalu 4
        Nk = key.length / 4; //dibagi 4 biar satuannya words (dari bytes)
        Nr = Nk + 6; // banyaknya putaran, disesuaikan dengan aturan AES

        int lenght = 0; //buat padding plaintext yang kurang dari 16
        byte[] padding = new byte[1];
        int i;
        lenght = 16 - in.length % 16; //menghitung panjangnya padding yang dibutuhkan
